...
def check_array(guess_array, guess, secret_number)
  ...
  elsif guess_array.any? {|n| (n < secret_number && guess < n) || (n > secret_number && guess > n)}
    print "Are you even paying attention to the hints I'm giving you? "
  end
end
...
while guess != secret_number
  ...
  guess_count += 1
  check_array(guess_array, guess, secret_number)
  guess_array << guess
